...
namespace ContosoU2016.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, 
                                               ...
                                               int? page) //? means nullable or optional
        {
            ...
            //dcowan: add paging, sorting and filtering functionality
            ...
            //rewrite on of the coalesing if
            //if(sortOrder == "fname_desc")
            //{
            ...
            //LINQ - Language Integrating Queries
            //Apply the Sorting
            switch(sortOrder)
            {
                case "lname_desc":
                    students = students.OrderByDescending(s => s.LastName); //s => jfdskjf Lamda Expressions
                    break;
                //FirstName
                case "fname":
            ...
            //dcowan: Changed to use paginated list
        ...
        public async Task<IActionResult> Details(int? id)
        {
            if (id == null)
            {
                 ...
                 * Status Codes
                 * Success:
                 * return Ok() <- HTTPs status code 200
            ...
            //dcowan: Update to include related data (enrollment
        ...
        {
            //dcowan: remove the id from the bind attributes: ID is the PK as well as IDENTITY
            try
            {
        ...
        public async Task<IActionResult> Delete(int? id, bool? saveChangesError=false)
        {
            ...
            //dcowan: return update error if necessary
